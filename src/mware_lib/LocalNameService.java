...
public class LocalNameService extends NameService {
	...
	public void rebind(Object servant, String name) {
		try {
			...
			RemoteInfo rInfo = new RemoteInfo(InetAddress.getLocalHost()
					.getHostAddress(), skeletonPort, objType.getSimpleName());
	...
	public Object generateObjectRef(String remoteType, String name,
			String skelHost, int skelPort) {
		Object resultObj = null;
		System.out.println("REMOTETYPE: " + remoteType);
		if (remoteType.equals("Manager")) {
			resultObj = new ManagerProxy(skelHost, skelPort, name);
		} else if (remoteType.equals("Account")) {
